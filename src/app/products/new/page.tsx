...
function NewProductForm() {
  ...
  const fetchSeriesPacks = useCallback(async (brandPackId: string) => {
    if (!brandPackId) {
      setSeriesPacks([]);
      return;
    }
    try {
      const res = await fetch(`/api/series-packs?brandPackId=${encodeURIComponent(brandPackId)}&pageSize=100`);
      if (res.ok) {
        const data = await res.json();
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({ ...prev, brandPackId: "", seriesPackId: "" }));
  }, [form.clientSpaceId, fetchBrandPacks]);
  ...
  }, [form.brandPackId, fetchSeriesPacks]);
    ...
    <div>
      <div className="max-w-4xl mx-auto px-4 py-8">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span>/</span>
          <span className="text-foreground font-medium">新增商品</span>
        </nav>

        <h1 className="text-2xl font-bold text-foreground mb-8">新增商品</h1>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    value={form.spu}
                    onChange={(e) => updateField("spu", e.target.value)}
                    placeholder="输入 SPU"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("clientSpaceId", e.target.value)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("compatibleModel", e.target.value)}
                    placeholder="输入兼容型号"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("packageContents", e.target.value)}
                    placeholder="输入包装内容"
                  />
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    value={form.coreSellingPoint1}
                    onChange={(e) => updateField("coreSellingPoint1", e.target.value)}
                    placeholder="输入核心卖点1"
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      value={form.coreSellingPoint2}
                      onChange={(e) => updateField("coreSellingPoint2", e.target.value)}
                      placeholder="输入核心卖点2"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.coreSellingPoint3}
                      onChange={(e) => updateField("coreSellingPoint3", e.target.value)}
                      placeholder="输入核心卖点3"
                    />
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      type="color"
                      value={form.mainColor || "#ffffff"}
                      onChange={(e) => updateField("mainColor", e.target.value)}
                      className="w-10 h-10 border border-border rounded cursor-pointer bg-card"
                    />
                    <input
                      type="text"
                      value={form.mainColor}
                      onChange={(e) => updateField("mainColor", e.target.value)}
                      placeholder="#000000 或 red"
                      className="flex-1 h-9 bg-card border border-border rounded-md px-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary/50 focus:ring-1 focus:ring-primary/20 outline-none transition-colors duration-150"
                    />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("shapeType", e.target.value)}
                    placeholder="输入形状类型"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("surfaceMaterial", e.target.value)}
                    placeholder="输入表面材质"
                  />
                </div>
                <div>
                  ...
                  <Input
                    value={form.textureFeature}
                    onChange={(e) => updateField("textureFeature", e.target.value)}
                    placeholder="输入纹理特征"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("labelPosition", e.target.value)}
                    placeholder="输入标签位置"
                  />
                </div>
              </div>
              <div className="mt-4">
                ...
                <Textarea
                  value={form.mustNotChangeFeatures}
                  onChange={(e) => updateField("mustNotChangeFeatures", e.target.value)}
                  placeholder={"每行一个特征，换行分隔\n例如：\n瓶身形状不变\n品牌Logo不可移除"}
                  rows={4}
                />
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    value={form.frontRefImage}
                    onChange={(e) => updateField("frontRefImage", e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      value={form.angle45RefImage}
                      onChange={(e) => updateField("angle45RefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.sideRefImage}
                      onChange={(e) => updateField("sideRefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.backRefImage}
                      onChange={(e) => updateField("backRefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.topRefImage}
                      onChange={(e) => updateField("topRefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.packagingRefImage}
                      onChange={(e) => updateField("packagingRefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.logoRefImage}
                      onChange={(e) => updateField("logoRefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={form.accessoryRefImage}
                      onChange={(e) => updateField("accessoryRefImage", e.target.value)}
                      placeholder="输入图片 URL"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Input
                    value={form.detailRefImages}
                    onChange={(e) => updateField("detailRefImages", e.target.value)}
